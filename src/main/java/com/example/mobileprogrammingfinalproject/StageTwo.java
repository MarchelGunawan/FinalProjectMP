...
public class StageTwo extends AppCompatActivity {
    ...
    int totalatkenemy = 800;
    int totaldefenemy = 420;
    ...
    public void check(int hpplayer, int hpenemy) {
        ...
        if(hpenemy <= 0){
            Toast.makeText(StageTwo.this, "You win", Toast.LENGTH_SHORT).show();
            btn_atk.setEnabled(false);
        }
    }
    ...
    public void clickBuff(View v){
        ...
        switch (v.getId()){
            case R.id.potion:
                if (amountC < 200){
                    Toast.makeText(StageTwo.this, "Didn't have enough Money", Toast.LENGTH_SHORT);
                }else{
                    amountC -= 200;
                    coin.setText(""+amountC);
    ...
    public void chooseChampion(View v){
        AlertDialog.Builder builder = new AlertDialog.Builder(StageTwo.this, R.style.AlertDialogTheme);
        View view = LayoutInflater.from(StageTwo.this).inflate(
        ...
        if(amountC <= 0 || amountC < 100){
            Toast.makeText(StageTwo.this, "You don't have enough money", Toast.LENGTH_SHORT).show();
        }
        else{
