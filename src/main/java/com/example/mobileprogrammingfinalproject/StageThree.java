...
public class StageThree extends AppCompatActivity {
    ...
    int totalatkenemy = 784;
    int totaldefenemy = 520;
    ...
    public void check(int hpplayer, int hpenemy) {
        ...
        if(hpenemy <= 0){
            Toast.makeText(StageThree.this, "You win", Toast.LENGTH_SHORT).show();
            btn_atk.setEnabled(false);
        }
    }
    ...
    public void clickBuff(View v){
        ...
        switch (v.getId()){
            case R.id.potion:
                if (amountC < 200){
                    Toast.makeText(StageThree.this, "Didn't have enough Money", Toast.LENGTH_SHORT);
                }else{
                    amountC -= 200;
                    coin.setText(""+amountC);
    ...
    public void chooseChampion(View v){
        AlertDialog.Builder builder = new AlertDialog.Builder(StageThree.this, R.style.AlertDialogTheme);
        View view = LayoutInflater.from(StageThree.this).inflate(
        ...
        if(amountC <= 0 || amountC < 100){
            Toast.makeText(StageThree.this, "You don't have enough money", Toast.LENGTH_SHORT).show();
        }
        else{
